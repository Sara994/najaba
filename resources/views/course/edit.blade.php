    ...
    <div class="container">
        <div class="edit-2 body">
            <div class="row">
                ...
                <div class="col-md-11">
                    <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="{{ url('course/'. $course->id .'/edit') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="location" type="text" class="form-control{{ $errors->has('location') ? ' is-invalid' : '' }}" name="location" value="{{ $course->location }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="duration" type="text" class="form-control{{ $errors->has('duration') ? ' is-invalid' : '' }}" name="duration" value="{{ $course->duration }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="time" type="text" class="form-control{{ $errors->has('time') ? ' is-invalid' : '' }}" name="time" value="{{ $course->time }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="number_of_seats" type="number" class="form-control{{ $errors->has('number_of_seats') ? ' is-invalid' : '' }}" name="number_of_seats" value="{{ $course->number_of_seats }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input pattern="(http(s)?:\/\/)?((w){3}.)?youtube?(\.com)?\/.+v=(.*)" placeholder="https://www.youtube.com/watch?v=" id="intro_video" type="text" class="form-control{{ $errors->has('intro_video') ? ' is-invalid' : '' }}" name="intro_video" value="{{ $course->intro_video }}" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="photo" type="file" class="form-control{{ $errors->has('photo') ? ' is-invalid' : '' }}" name="photo" value="{{ $course->photo }}" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <textarea rows="10" id="description" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" name="description">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <textarea rows="10" id="content" type="file" class="form-control{{ $errors->has('content') ? ' is-invalid' : '' }}" name="content">
