        ...
        <div class="carousel slide" data-ride="carousel" data-type="multi" data-interval="3000" id="myCarousel">
            <div class="carousel-inner">
                <div class="item active">
                    @foreach(App\Course::whereNull('content')->orderBy('created_at', 'desc')->limit(3)->get() as $course)
                ...
                <div class="item">
                    @foreach(App\Course::whereNull('content')->orderBy('created_at', 'desc')->limit(3)->offset(3)->get() as $course)
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="panel panel-default">
                                <div class="panel-header">
                                    <img src="{{$course->photo ? url($course->photo):url('images/placeholder.gif')}}" alt="silder1" class="img-responsive">
...
<section class="row">
    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="carousel slide" data-ride="carousel" data-type="multi" data-interval="3000" id="myCarousel1">
            <div class="carousel-inner">
                <div class="item active">
                    @foreach(App\Course::whereNotNull('content')->where('archieved',false)->orderBy('created_at', 'desc')->limit(3)->get() as $course)
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="panel panel-default">
                                <div class="panel-header">
                                    <img src="{{$course->photo ? url($course->photo):url('images/placeholder.gif')}}" alt="silder1" class="img-responsive">
...
<section class="row">
    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="carousel slide" data-ride="carousel" data-type="multi" data-interval="3000" id="myCarousel2">
            <div class="carousel-inner">
                <div class="item active">
                    @foreach(App\Course::where('archieved',true)->orderBy('created_at', 'desc')->limit(3)->get() as $course)
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="panel panel-default">
                                <div class="panel-header">
                                    <img src="{{$course->photo ? url($course->photo):url('images/placeholder.gif')}}" alt="silder1" class="img-responsive">
